...
```{r load data sets}
activity <- read.csv("/Users/nicolebroussard/Documents/Google Data Analytics Cert /Case Study/Data/dailyActivity_merged.csv")
calories <- read.csv("/Users/nicolebroussard/Documents/Google Data Analytics Cert /Case Study/Data/hourlyCalories_merged.csv")
heartrate <- read.csv("/Users/nicolebroussard/Documents/Google Data Analytics Cert /Case Study/Data/heartrate_seconds_merged.csv")
intensities <- read_csv("/Users/nicolebroussard/Documents/Google Data Analytics Cert /Case Study/Data/hourlyIntensities_merged.csv")
steps <- read_csv("/Users/nicolebroussard/Documents/Google Data Analytics Cert /Case Study/Data/hourlySteps_merged.csv")
```
